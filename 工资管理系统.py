...
class InfoEmploy:
    def __init__(self, gongzi_window):
        ...
        # btn3 = Button(self.window, text="  ", width=15, height=1, relief='raised', font=('Verdana', 20),
        #               command=lambda: guanliyuanxinxi(self.window),
        #               fg='white', bg='gray', activebackground='black',
        #               activeforeground='white')
        # btn3.grid(row=3, column=2, columnspan=1, padx=80, pady=30)

        # btn4 = Button(self.window, text="错误反馈", width=15, height=1, relief='raised', font=('Verdana', 20),
